...
----------------------------------
	...
	if IsInRaid() and db.raidannounce then
		SendChatMessage(taxiSrc.."-->"..taxiDst.." ".."("..FormatTime(endTime)..")", "RAID", nil, nil);
	elseif IsInGroup() and db.partyannounce then
		SendChatMessage(taxiSrc.."-->"..taxiDst.." ".."("..FormatTime(endTime)..")", "PARTY", nil, nil);
	-- else
		-- SendChatMessage(taxiSrc.."-->"..taxiDst.." ".."("..FormatTime(endTime)..")", "WHISPER", nil, GetUnitName("PLAYER"));
	end
	...
	if not InFlightDD then
		...
		InFlightDD.initialize = function(self, lvl)
			if lvl == 1 then
				...
				AddList(lvl, L["AnnounceOptions"], "announce")
			...
			elseif lvl == 2 then
				...
				elseif sub == "announce" then
					AddToggle(lvl, L["PartyAnnounce"], "partyannounce")
					AddToggle(lvl, L["RaidAnnounce"], "raidannounce")
